...
ALOHA_GRIPPER_NORMALIZE_FN = lambda x: 2 * ((x - PROPRIO_GRIPPER_CLOSE) / (ALOHA_GRIPPER_OPEN - PROPRIO_GRIPPER_CLOSE)) - 1 # - 0.115) / (1.185 - 0.115) - 1
ALOHA_GRIPPER_VELOCITY_NORMALIZE_FN = lambda x: x / (ALOHA_GRIPPER_OPEN - PROPRIO_GRIPPER_CLOSE)